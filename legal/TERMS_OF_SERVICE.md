...
By downloading, installing, or using The Ice Cream Man mobile application ("App"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, do not use the App.
...
To use the App, you must create an account. You agree to provide accurate, current, and complete information during registration and to update such information to keep it accurate.
...
| Account Type | Description | Fee |
|--------------|-------------|-----|
| Customer | Request ice cream vendors | Free |
| Vendor | Receive and fulfill customer requests | $25 one-time registration fee |

---

## 4. Vendor Registration Fee

### 4.1 Fee Amount

Ice cream vendors are required to pay a one-time registration fee of $25.00 USD to activate their vendor account.

### 4.2 Payment Processing

All payments are processed through Google Play Billing. By making a purchase, you agree to Google Play's terms of service.

### 4.3 Refund Policy

The vendor registration fee is non-refundable once the vendor account has been activated. Refund requests for unused accounts may be submitted within 48 hours of purchase to mindy.gaines1@gmail.com.
...
- Not engage in price gouging or deceptive practices
...
The App requires access to your device's location to connect you with nearby vendors. Location data is used solely for the purpose of facilitating ice cream deliveries.

### 6.2 Vendor Location

Vendors who are online and active will have their location shared with customers who have placed a request. This enables real-time tracking of the vendor's approach.
...
All content, features, and functionality of the App, including but not limited to text, graphics, logos, icons, images, and software, are the property of Mindy Gaines and are protected by copyright, trademark, and other intellectual property laws.

### 7.2 User Content

By submitting content to the App (reviews, ratings, profile information), you grant us a non-exclusive, worldwide, royalty-free license to use, display, and distribute such content in connection with the App.
...
We do not guarantee that a vendor will be available to fulfill every customer request. Availability depends on vendor participation in your area.
...
Any disputes arising from these Terms or your use of the App shall be resolved through binding arbitration in accordance with the rules of the American Arbitration Association, conducted in Portland, Oregon.

---

## 15. Changes to Terms

We reserve the right to modify these Terms at any time. We will notify users of material changes through the App or via email. Continued use of the App after changes constitutes acceptance of the modified Terms.
...
**By using The Ice Cream Man app, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.**
